...
void glIndexedPrint(const packed_call_t *packed) {
    switch (packed->index) {
        ...
        case glFrustumf_INDEX: {
            ...
            printf("glFrustumf(%0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f);\n", args->left, args->right, args->bottom, args->top, args->near, args->far);
            break;
        }
        case glFrustumfOES_INDEX: {
...
const int INDEX_RET_SIZE[] = {
    ...
    [glBlendColorOES_INDEX] =     0,
    [glBlendEquation_INDEX] =     0,
    [glBlendEquationOES_INDEX] =     0,
    [glBlendEquationSeparate_INDEX] =     0,
    [glBlendEquationSeparateOES_INDEX] =     0,
    [glBlendEquationSeparatei_INDEX] =     0,
    [glBlendFunc_INDEX] =     0,
    [glBlendFuncSeparate_INDEX] =     0,
    [glBlendFuncSeparateOES_INDEX] =     0,
    ...
    [glGetClipPlanef_INDEX] =     0,
    [glGetClipPlanefOES_INDEX] =     0,
    [glGetClipPlanex_INDEX] =     0,
    ...
    [glLightModelx_INDEX] =     0,
    [glLightModelxv_INDEX] =     0,
    [glLightf_INDEX] =     0,
    [glLightfv_INDEX] =     0,
    [glLighti_INDEX] =     0,
    [glLightiv_INDEX] =     0,
    ...
    [glPointParameterx_INDEX] =     0,
    [glPointParameterxv_INDEX] =     0,
    [glPointSize_INDEX] =     0,
    [glPointSizePointerOES_INDEX] =     0,
    [glPointSizex_INDEX] =     0,
    [glPolygonMode_INDEX] =     0,
    [glPolygonOffset_INDEX] =     0,
    [glPolygonOffsetx_INDEX] =     0,
...
const int INDEX_PACKED_SIZE[] = {
    ...
    [glAlphaFuncx_INDEX] = sizeof(glAlphaFuncx_PACKED),
    ...
    [glBlendColorOES_INDEX] = sizeof(glBlendColorOES_PACKED),
    [glBlendEquation_INDEX] = sizeof(glBlendEquation_PACKED),
    [glBlendEquationOES_INDEX] = sizeof(glBlendEquationOES_PACKED),
    [glBlendEquationSeparate_INDEX] = sizeof(glBlendEquationSeparate_PACKED),
    [glBlendEquationSeparateOES_INDEX] = sizeof(glBlendEquationSeparateOES_PACKED),
    ...
    [glBlendFuncSeparateOES_INDEX] = sizeof(glBlendFuncSeparateOES_PACKED),
    ...
    [glClearColorx_INDEX] = sizeof(glClearColorx_PACKED),
    ...
    [glClearDepthx_INDEX] = sizeof(glClearDepthx_PACKED),
    ...
    [glClipPlanef_INDEX] = sizeof(glClipPlanef_PACKED),
    [glClipPlanefOES_INDEX] = sizeof(glClipPlanefOES_PACKED),
    [glClipPlanex_INDEX] = sizeof(glClipPlanex_PACKED),
    ...
    [glColor4x_INDEX] = sizeof(glColor4x_PACKED),
    ...
    [glDepthRangex_INDEX] = sizeof(glDepthRangex_PACKED),
    ...
    [glFogx_INDEX] = sizeof(glFogx_PACKED),
    [glFogxv_INDEX] = sizeof(glFogxv_PACKED),
    [glFrontFace_INDEX] = sizeof(glFrontFace_PACKED),
    [glFrustum_INDEX] = sizeof(glFrustum_PACKED),
    [glFrustumf_INDEX] = sizeof(glFrustumf_PACKED),
    [glFrustumfOES_INDEX] = sizeof(glFrustumfOES_PACKED),
    [glFrustumx_INDEX] = sizeof(glFrustumx_PACKED),
    ...
    [glGetClipPlanef_INDEX] = sizeof(glGetClipPlanef_PACKED),
    [glGetClipPlanefOES_INDEX] = sizeof(glGetClipPlanefOES_PACKED),
    [glGetClipPlanex_INDEX] = sizeof(glGetClipPlanex_PACKED),
    [glGetDoublev_INDEX] = sizeof(glGetDoublev_PACKED),
    [glGetError_INDEX] = sizeof(glGetError_PACKED),
    [glGetFixedv_INDEX] = sizeof(glGetFixedv_PACKED),
    ...
    [glGetLightxv_INDEX] = sizeof(glGetLightxv_PACKED),
    ...
    [glGetMaterialxv_INDEX] = sizeof(glGetMaterialxv_PACKED),
    ...
    [glGetTexEnvxv_INDEX] = sizeof(glGetTexEnvxv_PACKED),
    ...
    [glGetTexParameterxv_INDEX] = sizeof(glGetTexParameterxv_PACKED),
    ...
    [glLightModelx_INDEX] = sizeof(glLightModelx_PACKED),
    [glLightModelxv_INDEX] = sizeof(glLightModelxv_PACKED),
    ...
    [glLightx_INDEX] = sizeof(glLightx_PACKED),
    [glLightxv_INDEX] = sizeof(glLightxv_PACKED),
    [glLineStipple_INDEX] = sizeof(glLineStipple_PACKED),
    [glLineWidth_INDEX] = sizeof(glLineWidth_PACKED),
    [glLineWidthx_INDEX] = sizeof(glLineWidthx_PACKED),
    ...
    [glLoadMatrixx_INDEX] = sizeof(glLoadMatrixx_PACKED),
    ...
    [glMaterialx_INDEX] = sizeof(glMaterialx_PACKED),
    [glMaterialxv_INDEX] = sizeof(glMaterialxv_PACKED),
    ...
    [glMultMatrixx_INDEX] = sizeof(glMultMatrixx_PACKED),
    ...
    [glMultiTexCoord4x_INDEX] = sizeof(glMultiTexCoord4x_PACKED),
    ...
    [glPointParameterx_INDEX] = sizeof(glPointParameterx_PACKED),
    [glPointParameterxv_INDEX] = sizeof(glPointParameterxv_PACKED),
    [glPointSize_INDEX] = sizeof(glPointSize_PACKED),
    [glPointSizePointerOES_INDEX] = sizeof(glPointSizePointerOES_PACKED),
    [glPointSizex_INDEX] = sizeof(glPointSizex_PACKED),
    [glPolygonMode_INDEX] = sizeof(glPolygonMode_PACKED),
    [glPolygonOffset_INDEX] = sizeof(glPolygonOffset_PACKED),
    [glPolygonOffsetx_INDEX] = sizeof(glPolygonOffsetx_PACKED),
    ...
    [glRotatex_INDEX] = sizeof(glRotatex_PACKED),
    [glSampleCoverage_INDEX] = sizeof(glSampleCoverage_PACKED),
    [glSampleCoveragex_INDEX] = sizeof(glSampleCoveragex_PACKED),
    [glScaled_INDEX] = sizeof(glScaled_PACKED),
    [glScalef_INDEX] = sizeof(glScalef_PACKED),
    [glScalex_INDEX] = sizeof(glScalex_PACKED),
    ...
    [glTexEnvx_INDEX] = sizeof(glTexEnvx_PACKED),
    [glTexEnvxv_INDEX] = sizeof(glTexEnvxv_PACKED),
    ...
    [glTexParameterx_INDEX] = sizeof(glTexParameterx_PACKED),
    [glTexParameterxv_INDEX] = sizeof(glTexParameterxv_PACKED),
    ...
    [glTranslatex_INDEX] = sizeof(glTranslatex_PACKED),
...
const char *INDEX_NAME[] = {
    ...
    [glAlphaFuncx_INDEX] = "glAlphaFuncx",
    ...
    [glBlendColorOES_INDEX] = "glBlendColorOES",
    [glBlendEquation_INDEX] = "glBlendEquation",
    [glBlendEquationOES_INDEX] = "glBlendEquationOES",
    [glBlendEquationSeparate_INDEX] = "glBlendEquationSeparate",
    [glBlendEquationSeparateOES_INDEX] = "glBlendEquationSeparateOES",
    ...
    [glBlendFuncSeparateOES_INDEX] = "glBlendFuncSeparateOES",
    ...
    [glClipPlanef_INDEX] = "glClipPlanef",
    [glClipPlanefOES_INDEX] = "glClipPlanefOES",
    [glClipPlanex_INDEX] = "glClipPlanex",
    ...
    [glDepthRangex_INDEX] = "glDepthRangex",
    ...
    [glGetMaterialxv_INDEX] = "glGetMaterialxv",
    ...
    [glGetTexEnvxv_INDEX] = "glGetTexEnvxv",
    ...
    [glGetTexParameterxv_INDEX] = "glGetTexParameterxv",
    [glHint_INDEX] = "glHint",
    ...
    [glLoadMatrixx_INDEX] = "glLoadMatrixx",
    ...
    [glMultiTexCoord4x_INDEX] = "glMultiTexCoord4x",
    ...
    [glPointParameterx_INDEX] = "glPointParameterx",
    [glPointParameterxv_INDEX] = "glPointParameterxv",
    [glPointSize_INDEX] = "glPointSize",
    [glPointSizePointerOES_INDEX] = "glPointSizePointerOES",
    [glPointSizex_INDEX] = "glPointSizex",
    [glPolygonMode_INDEX] = "glPolygonMode",
    [glPolygonOffset_INDEX] = "glPolygonOffset",
    [glPolygonOffsetx_INDEX] = "glPolygonOffsetx",
    ...
    [glRotatex_INDEX] = "glRotatex",
    [glSampleCoverage_INDEX] = "glSampleCoverage",
    [glSampleCoveragex_INDEX] = "glSampleCoveragex",
    [glScaled_INDEX] = "glScaled",
    [glScalef_INDEX] = "glScalef",
    [glScalex_INDEX] = "glScalex",
    ...
    [glTexEnvx_INDEX] = "glTexEnvx",
    [glTexEnvxv_INDEX] = "glTexEnvxv",
    ...
    [glTexParameterx_INDEX] = "glTexParameterx",
    [glTexParameterxv_INDEX] = "glTexParameterxv",
    ...
    [glTranslatex_INDEX] = "glTranslatex",
...
packed_call_t *pack_glAlphaFuncx(glAlphaFuncx_PACKED *_dst, GLenum func, GLclampx ref) {
    if (_dst == NULL) _dst = malloc(sizeof(glAlphaFuncx_PACKED));
    _dst->index = glAlphaFuncx_INDEX;
    _dst->args.func = (GLenum)func;
    _dst->args.ref = (GLclampx)ref;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glBlendColorOES(glBlendColorOES_PACKED *_dst, GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
    if (_dst == NULL) _dst = malloc(sizeof(glBlendColorOES_PACKED));
    _dst->index = glBlendColorOES_INDEX;
    _dst->args.red = (GLclampf)red;
    _dst->args.green = (GLclampf)green;
    _dst->args.blue = (GLclampf)blue;
    _dst->args.alpha = (GLclampf)alpha;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glBlendEquationOES(glBlendEquationOES_PACKED *_dst, GLenum mode) {
    if (_dst == NULL) _dst = malloc(sizeof(glBlendEquationOES_PACKED));
    _dst->index = glBlendEquationOES_INDEX;
    _dst->args.mode = (GLenum)mode;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glBlendEquationSeparateOES(glBlendEquationSeparateOES_PACKED *_dst, GLenum modeRGB, GLenum modeAlpha) {
    if (_dst == NULL) _dst = malloc(sizeof(glBlendEquationSeparateOES_PACKED));
    _dst->index = glBlendEquationSeparateOES_INDEX;
    _dst->args.modeRGB = (GLenum)modeRGB;
    _dst->args.modeAlpha = (GLenum)modeAlpha;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glBlendFuncSeparateOES(glBlendFuncSeparateOES_PACKED *_dst, GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha) {
    if (_dst == NULL) _dst = malloc(sizeof(glBlendFuncSeparateOES_PACKED));
    _dst->index = glBlendFuncSeparateOES_INDEX;
    _dst->args.sfactorRGB = (GLenum)sfactorRGB;
    _dst->args.dfactorRGB = (GLenum)dfactorRGB;
    _dst->args.sfactorAlpha = (GLenum)sfactorAlpha;
    _dst->args.dfactorAlpha = (GLenum)dfactorAlpha;
...
packed_call_t *pack_glClearColorx(glClearColorx_PACKED *_dst, GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha) {
    if (_dst == NULL) _dst = malloc(sizeof(glClearColorx_PACKED));
    _dst->index = glClearColorx_INDEX;
    _dst->args.red = (GLclampx)red;
    _dst->args.green = (GLclampx)green;
    _dst->args.blue = (GLclampx)blue;
    _dst->args.alpha = (GLclampx)alpha;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glClearDepthx(glClearDepthx_PACKED *_dst, GLclampx depth) {
    if (_dst == NULL) _dst = malloc(sizeof(glClearDepthx_PACKED));
    _dst->index = glClearDepthx_INDEX;
    _dst->args.depth = (GLclampx)depth;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glClipPlanef(glClipPlanef_PACKED *_dst, GLenum plane, const GLfloat * equation) {
    if (_dst == NULL) _dst = malloc(sizeof(glClipPlanef_PACKED));
    _dst->index = glClipPlanef_INDEX;
    _dst->args.plane = (GLenum)plane;
...
packed_call_t *pack_glClipPlanex(glClipPlanex_PACKED *_dst, GLenum plane, const GLfixed * equation) {
    if (_dst == NULL) _dst = malloc(sizeof(glClipPlanex_PACKED));
    _dst->index = glClipPlanex_INDEX;
    _dst->args.plane = (GLenum)plane;
    _dst->args.equation = (GLfixed *)equation;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glColor4x(glColor4x_PACKED *_dst, GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha) {
    if (_dst == NULL) _dst = malloc(sizeof(glColor4x_PACKED));
    _dst->index = glColor4x_INDEX;
    _dst->args.red = (GLfixed)red;
    _dst->args.green = (GLfixed)green;
    _dst->args.blue = (GLfixed)blue;
    _dst->args.alpha = (GLfixed)alpha;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glDepthRangex(glDepthRangex_PACKED *_dst, GLclampx near, GLclampx far) {
    if (_dst == NULL) _dst = malloc(sizeof(glDepthRangex_PACKED));
    _dst->index = glDepthRangex_INDEX;
    _dst->args.near = (GLclampx)near;
    _dst->args.far = (GLclampx)far;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glFogx(glFogx_PACKED *_dst, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glFogx_PACKED));
    _dst->index = glFogx_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glFogxv(glFogxv_PACKED *_dst, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glFogxv_PACKED));
    _dst->index = glFogxv_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glFrustumf(glFrustumf_PACKED *_dst, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far) {
    if (_dst == NULL) _dst = malloc(sizeof(glFrustumf_PACKED));
    _dst->index = glFrustumf_INDEX;
    _dst->args.left = (GLfloat)left;
    _dst->args.right = (GLfloat)right;
    _dst->args.bottom = (GLfloat)bottom;
    _dst->args.top = (GLfloat)top;
    _dst->args.near = (GLfloat)near;
    _dst->args.far = (GLfloat)far;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glFrustumx(glFrustumx_PACKED *_dst, GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed near, GLfixed far) {
    if (_dst == NULL) _dst = malloc(sizeof(glFrustumx_PACKED));
    _dst->index = glFrustumx_INDEX;
    _dst->args.left = (GLfixed)left;
    _dst->args.right = (GLfixed)right;
    _dst->args.bottom = (GLfixed)bottom;
    _dst->args.top = (GLfixed)top;
    _dst->args.near = (GLfixed)near;
    _dst->args.far = (GLfixed)far;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glGetClipPlanef(glGetClipPlanef_PACKED *_dst, GLenum plane, GLfloat * equation) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetClipPlanef_PACKED));
    _dst->index = glGetClipPlanef_INDEX;
    _dst->args.plane = (GLenum)plane;
    _dst->args.equation = (GLfloat *)equation;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glGetClipPlanex(glGetClipPlanex_PACKED *_dst, GLenum plane, GLfixed * equation) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetClipPlanex_PACKED));
    _dst->index = glGetClipPlanex_INDEX;
    _dst->args.plane = (GLenum)plane;
    _dst->args.equation = (GLfixed *)equation;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glGetFixedv(glGetFixedv_PACKED *_dst, GLenum pname, GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetFixedv_PACKED));
    _dst->index = glGetFixedv_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glGetLightxv(glGetLightxv_PACKED *_dst, GLenum light, GLenum pname, GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetLightxv_PACKED));
    _dst->index = glGetLightxv_INDEX;
    _dst->args.light = (GLenum)light;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glGetMaterialxv(glGetMaterialxv_PACKED *_dst, GLenum face, GLenum pname, GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetMaterialxv_PACKED));
    _dst->index = glGetMaterialxv_INDEX;
    _dst->args.face = (GLenum)face;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glGetTexEnvxv(glGetTexEnvxv_PACKED *_dst, GLenum target, GLenum pname, GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetTexEnvxv_PACKED));
    _dst->index = glGetTexEnvxv_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glGetTexParameterxv(glGetTexParameterxv_PACKED *_dst, GLenum target, GLenum pname, GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glGetTexParameterxv_PACKED));
    _dst->index = glGetTexParameterxv_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glLightModelx(glLightModelx_PACKED *_dst, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glLightModelx_PACKED));
    _dst->index = glLightModelx_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glLightModelxv(glLightModelxv_PACKED *_dst, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glLightModelxv_PACKED));
    _dst->index = glLightModelxv_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glLightx(glLightx_PACKED *_dst, GLenum light, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glLightx_PACKED));
    _dst->index = glLightx_INDEX;
    _dst->args.light = (GLenum)light;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glLightxv(glLightxv_PACKED *_dst, GLenum light, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glLightxv_PACKED));
    _dst->index = glLightxv_INDEX;
    _dst->args.light = (GLenum)light;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glLineWidthx(glLineWidthx_PACKED *_dst, GLfixed width) {
    if (_dst == NULL) _dst = malloc(sizeof(glLineWidthx_PACKED));
    _dst->index = glLineWidthx_INDEX;
    _dst->args.width = (GLfixed)width;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glLoadMatrixx(glLoadMatrixx_PACKED *_dst, const GLfixed * m) {
    if (_dst == NULL) _dst = malloc(sizeof(glLoadMatrixx_PACKED));
    _dst->index = glLoadMatrixx_INDEX;
    _dst->args.m = (GLfixed *)m;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glMaterialx(glMaterialx_PACKED *_dst, GLenum face, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glMaterialx_PACKED));
    _dst->index = glMaterialx_INDEX;
    _dst->args.face = (GLenum)face;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glMaterialxv(glMaterialxv_PACKED *_dst, GLenum face, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glMaterialxv_PACKED));
    _dst->index = glMaterialxv_INDEX;
    _dst->args.face = (GLenum)face;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glMultMatrixx(glMultMatrixx_PACKED *_dst, const GLfixed * m) {
    if (_dst == NULL) _dst = malloc(sizeof(glMultMatrixx_PACKED));
    _dst->index = glMultMatrixx_INDEX;
    _dst->args.m = (GLfixed *)m;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glMultiTexCoord4x(glMultiTexCoord4x_PACKED *_dst, GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q) {
    if (_dst == NULL) _dst = malloc(sizeof(glMultiTexCoord4x_PACKED));
    _dst->index = glMultiTexCoord4x_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.s = (GLfixed)s;
    _dst->args.t = (GLfixed)t;
    _dst->args.r = (GLfixed)r;
    _dst->args.q = (GLfixed)q;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glNormal3x(glNormal3x_PACKED *_dst, GLfixed nx, GLfixed ny, GLfixed nz) {
    if (_dst == NULL) _dst = malloc(sizeof(glNormal3x_PACKED));
    _dst->index = glNormal3x_INDEX;
    _dst->args.nx = (GLfixed)nx;
    _dst->args.ny = (GLfixed)ny;
    _dst->args.nz = (GLfixed)nz;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glOrthof(glOrthof_PACKED *_dst, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far) {
    if (_dst == NULL) _dst = malloc(sizeof(glOrthof_PACKED));
    _dst->index = glOrthof_INDEX;
    _dst->args.left = (GLfloat)left;
    _dst->args.right = (GLfloat)right;
    _dst->args.bottom = (GLfloat)bottom;
    _dst->args.top = (GLfloat)top;
...
packed_call_t *pack_glOrthox(glOrthox_PACKED *_dst, GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed near, GLfixed far) {
    if (_dst == NULL) _dst = malloc(sizeof(glOrthox_PACKED));
    _dst->index = glOrthox_INDEX;
    _dst->args.left = (GLfixed)left;
    _dst->args.right = (GLfixed)right;
    _dst->args.bottom = (GLfixed)bottom;
    _dst->args.top = (GLfixed)top;
...
packed_call_t *pack_glPointParameterx(glPointParameterx_PACKED *_dst, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glPointParameterx_PACKED));
    _dst->index = glPointParameterx_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glPointParameterxv(glPointParameterxv_PACKED *_dst, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glPointParameterxv_PACKED));
    _dst->index = glPointParameterxv_INDEX;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glPointSizePointerOES(glPointSizePointerOES_PACKED *_dst, GLenum type, GLsizei stride, const GLvoid * pointer) {
    if (_dst == NULL) _dst = malloc(sizeof(glPointSizePointerOES_PACKED));
    _dst->index = glPointSizePointerOES_INDEX;
    _dst->args.type = (GLenum)type;
    _dst->args.stride = (GLsizei)stride;
    _dst->args.pointer = (GLvoid *)pointer;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glPointSizex(glPointSizex_PACKED *_dst, GLfixed size) {
    if (_dst == NULL) _dst = malloc(sizeof(glPointSizex_PACKED));
    _dst->index = glPointSizex_INDEX;
    _dst->args.size = (GLfixed)size;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glPolygonOffsetx(glPolygonOffsetx_PACKED *_dst, GLfixed factor, GLfixed units) {
    if (_dst == NULL) _dst = malloc(sizeof(glPolygonOffsetx_PACKED));
    _dst->index = glPolygonOffsetx_INDEX;
    _dst->args.factor = (GLfixed)factor;
    _dst->args.units = (GLfixed)units;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glRotatex(glRotatex_PACKED *_dst, GLfixed angle, GLfixed x, GLfixed y, GLfixed z) {
    if (_dst == NULL) _dst = malloc(sizeof(glRotatex_PACKED));
    _dst->index = glRotatex_INDEX;
    _dst->args.angle = (GLfixed)angle;
    _dst->args.x = (GLfixed)x;
    _dst->args.y = (GLfixed)y;
    _dst->args.z = (GLfixed)z;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glSampleCoveragex(glSampleCoveragex_PACKED *_dst, GLclampx value, GLboolean invert) {
    if (_dst == NULL) _dst = malloc(sizeof(glSampleCoveragex_PACKED));
    _dst->index = glSampleCoveragex_INDEX;
    _dst->args.value = (GLclampx)value;
    _dst->args.invert = (GLboolean)invert;
    return (packed_call_t *)_dst;
}
...
packed_call_t *pack_glScalex(glScalex_PACKED *_dst, GLfixed x, GLfixed y, GLfixed z) {
    if (_dst == NULL) _dst = malloc(sizeof(glScalex_PACKED));
    _dst->index = glScalex_INDEX;
    _dst->args.x = (GLfixed)x;
    _dst->args.y = (GLfixed)y;
    _dst->args.z = (GLfixed)z;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glTexEnvx(glTexEnvx_PACKED *_dst, GLenum target, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glTexEnvx_PACKED));
    _dst->index = glTexEnvx_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glTexEnvxv(glTexEnvxv_PACKED *_dst, GLenum target, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glTexEnvxv_PACKED));
    _dst->index = glTexEnvxv_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glTexParameterx(glTexParameterx_PACKED *_dst, GLenum target, GLenum pname, GLfixed param) {
    if (_dst == NULL) _dst = malloc(sizeof(glTexParameterx_PACKED));
    _dst->index = glTexParameterx_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.param = (GLfixed)param;
    return (packed_call_t *)_dst;
}
packed_call_t *pack_glTexParameterxv(glTexParameterxv_PACKED *_dst, GLenum target, GLenum pname, const GLfixed * params) {
    if (_dst == NULL) _dst = malloc(sizeof(glTexParameterxv_PACKED));
    _dst->index = glTexParameterxv_INDEX;
    _dst->args.target = (GLenum)target;
    _dst->args.pname = (GLenum)pname;
    _dst->args.params = (GLfixed *)params;
    return (packed_call_t *)_dst;
...
packed_call_t *pack_glTranslatex(glTranslatex_PACKED *_dst, GLfixed x, GLfixed y, GLfixed z) {
    if (_dst == NULL) _dst = malloc(sizeof(glTranslatex_PACKED));
    _dst->index = glTranslatex_INDEX;
    _dst->args.x = (GLfixed)x;
    _dst->args.y = (GLfixed)y;
    _dst->args.z = (GLfixed)z;
    return (packed_call_t *)_dst;
