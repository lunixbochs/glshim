...
*************************************************************************/
Pixel32 getColourA(PVRTuint32 u32ColourData)
{
	Pixel32 colour;
...
*************************************************************************/
Pixel32 getColourB(PVRTuint32 u32ColourData)
{ 
	Pixel32 colour;
...
*************************************************************************/
void interpolateColours(Pixel32 P, Pixel32 Q, Pixel32 R, Pixel32 S, 
...
*************************************************************************/
void unpackModulations(const PVRTCWord& word, int offsetX, int offsetY, PVRTint32 i32ModulationValues[16][8], PVRTint32 i32ModulationModes[16][8], PVRTuint8 ui8Bpp)
{	
...
*************************************************************************/
PVRTint32 getModulationValues(PVRTint32 i32ModulationValues[16][8],PVRTint32 i32ModulationModes[16][8],PVRTuint32 xPos,PVRTuint32 yPos,PVRTuint8 ui8Bpp)
{
	if (ui8Bpp==2)
	{
